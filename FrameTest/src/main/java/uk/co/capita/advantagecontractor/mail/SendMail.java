package uk.co.capita.advantagecontractor.mail;
...

{
	public static void sendMail() throws Exception {
		...
		// mail extent reports
		String[] to = {"p10405304@capita.co.uk"};
		String[] cc = {"Ajay.V@capita.co.uk"};
		String[] bcc = {};

		//This is for yahoo

		sendMail("p10405304@capita.co.uk",
				"Aditi123",
				"m.outlook.com",
				"587",
				"true",
				...
				"Please find attached the automation test reports with this mail .\n\n Regards\nWebMaster",
				extentFilePath,
				fileName);
